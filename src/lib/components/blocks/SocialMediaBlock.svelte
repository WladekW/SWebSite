<script>
  var {direction = "column"} = $props();
</script>

<div style="flex-direction: {direction};">
  <a href="/" aria-label="Facebook">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="social_icon">
  ...
  <a href="/" aria-label="Instagram">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" class="social_icon">
  ...
  <a href="/" aria-label="YouTube">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="currentColor" class="social_icon">
